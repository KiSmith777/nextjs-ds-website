...
const report_modal_ReportModal = ({ show , handleModal  })=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)((Modal_default()), {
...
report_modal_ReportModal.propTypes = {
    show: (external_prop_types_default()).bool.isRequired,
    handleModal: (external_prop_types_default()).func.isRequired
};
/* harmony default export */ const report_modal = ((/* unused pure expression or super */ null && (report_modal_ReportModal)));
...
const ShareDropdown = ()=>{
    const { 0: showShareModal , 1: setShowShareModal  } = useState(false);
    const { 0: showReportModal , 1: setShowReportModal  } = useState(false);
...
/* harmony default export */ const share_dropdown = ((/* unused pure expression or super */ null && (ShareDropdown)));
